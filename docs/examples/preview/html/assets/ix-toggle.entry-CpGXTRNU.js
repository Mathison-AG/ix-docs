...
const Toggle = class {
  ...
  render() {
    ...
    return h(Host, { key: "807077cc3f88a07d4f2190c2fcc3efb0a80c8e9a", class: {
      disabled: this.disabled
    }, onBlur: () => this.ixBlur.emit(), onFocus: () => this.touched = true }, h("label", { key: "f7db15aee9a44c2ad5f7a601a35a8b6a379b8c4f", class: "wrapper" }, h("button", { key: "269a07cf2dc6702aedc0508899abd5d5bc0f0c86", role: "switch", "aria-checked": a11yBoolean(this.checked), class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, onClick: () => this.onCheckedChange(!this.checked) }, h("div", { key: "6f4c20a665073f96fcb41a1a37dd6c05a89a12a2", class: "slider" })), h("input", { key: "c341af5b82bc5b94a53fa97f84b2d67a2c2908ad", type: "checkbox", disabled: this.disabled, indeterminate: this.indeterminate, checked: this.checked, tabindex: 0, "aria-hidden": a11yBoolean(true), "aria-checked": a11yBoolean(this.checked), onChange: (event) => this.onCheckedChange(event.target.checked) }), !this.hideText && h("ix-typography", { key: "c4a050ead4bedccb32c36137facb97718aad9153", class: "label" }, toggleText)));
  }
