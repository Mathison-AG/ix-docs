...
import { s as showAppSwitch } from "./index-CloNzCnH-CypUaLUW.js";
...
import { P as iconNavigationLeft, Q as iconNavigationRight, e as iconApps, R as iconCogwheel, S as iconLightDark, i as iconInfo } from "./index-Cz75KU1f-BUHLjWzB.js";
...
const Menu = class {
  ...
  render() {
    var _a, _b;
    return h(Host, { key: "0ff05f288c92217c8a8d820dd4a529f2a8e5057a", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "3891942ea2d75ec321feea0f11616eb694702e0a", class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "c525e29ea5e950a106cc2a5d9187f59a159c6225", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "374b5aad4ba6dd1fbd86430b1dfd9d09fd38f954", breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", ixAriaLabel: this.i18nExpandSidebar, onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && h("ix-icon-button", { key: "5ae72ad8a26a0badc36b969487741fd245a159b6", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, ghost: true })), h("div", { key: "6e9a23bbaad8157c5c356194309cd4a5fbe49eda", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "99e5fca0016414249ad4e9cb8dc67a08c664c811", class: "tabs-shadow-container" }, h("div", { key: "2ec034cc5167c6f6df7d10a3a8fc47df084cc6aa", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "edc9f72640f4d7be501415508abfb4bf2e138c7b", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "fcf8970bf9f41cb0f5dc99a2051cc48e0f0db4a4", class: "menu-avatar" }, h("slot", { key: "dd98099027b1e97216974210a91ff7fdcddd6a67", name: "ix-menu-avatar" })), h("slot", { key: "4c9f017e64948c78bd8e3951e4a7ab0f590885ba", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "81a69624bc43d13239f1357edf632daf04979982", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "78a8aca5882a48ca212fb20342d8ecfe12857262", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: iconCogwheel, onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: iconLightDark, label: this.i18nToggleTheme }) : null, h("div", { key: "ae679ce3da88ab8ea621507d33056c511fee0c19", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "32b5f6e0b1ef60933559c96b3dcb46c2035e14f5", name: "bottom" })), h("div", { key: "d44ccaa35e42166833f756d68784a9c415a890df", id: "popover-area" }), this.enableMapExpand || ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.sidebar) ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() }) : null, this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal }) : null), h("div", { key: "6f17fd0ade453470f22c867236b0093708849911", class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "aeb73973e3ebfb9541b4dc7473305b5e970d64bf", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "5a35f39cb677da2f608a6130055173be1cb18098", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  get hostElement() {
