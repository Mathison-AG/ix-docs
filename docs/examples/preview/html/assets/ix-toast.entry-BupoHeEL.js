...
import { q as iconClose, a as iconWarning, c as iconSuccess, b as iconError, i as iconInfo } from "./index-Cz75KU1f-BUHLjWzB.js";
...
const Toast = class {
  ...
  render() {
    ...
    return h(Host, { key: "7bc7fee64ae60ab2e25319715862d7d5ac69411d", class: "animate__animated animate__fadeIn" }, h("div", { key: "747993dc3f55f033ed51e56f36bb8aa06046091d", class: "toast-body", onPointerLeave: () => {
      this.touched = false;
    }, onPointerEnter: () => {
      this.touched = true;
    } }, this.type || this.icon ? h("div", { class: "toast-icon" }, this.getIcon()) : null, h("div", { key: "8bf89093a489a20095464036dd076aab9b21f308", class: "toast-content" }, this.toastTitle ? h("ix-typography", { class: "toast-title", format: "h5" }, this.toastTitle) : null, h("div", { key: "d9001f0eeeec415b9908d63394562dc61f1cb174", class: "toast-message" }, h("slot", { key: "df06dd040ebc02f30e9a245b6797c57cff34bdf6" })), h("div", { key: "55351e3e62360a0a3aa71e6f31061f6ce184aefb", class: "toast-action" }, h("slot", { key: "cd5410587fc3bd95de25f6369145f83cf0d28a36", name: "action" }))), h("div", { key: "b1fae1d1011df6557b3e2279a01f67088fe99499", class: "toast-close" }, h("ix-icon-button", { key: "bed879540c07cd17b9ff7a8175797f4189284fd6", icon: iconClose, iconColor: "color-soft-text", size: "24", ghost: true, onClick: () => this.closeToast.emit(), "aria-label": this.ariaLabelCloseIconButton }))), this.autoClose ? h("div", { class: progressBarClass.join(" "), style: progressBarStyle, onAnimationEnd: () => {
      this.close();
    }, onTransitionEnd: () => {
      if (this.progress === 0) {
        this.close();
