import { r as registerInstance, f as forceUpdate, h, H as Host, c as createEvent, F as Fragment, g as getElement } from "./global-C3NZUKAC.js";
import { m as matchBreakpoint } from "./breakpoints-D6vSVaHq-Ca0ODf6_.js";
import { w as iconChevronRightSmall, E as iconChevronLeftSmall, O as iconSingleCheck } from "./index-Cz75KU1f-BUHLjWzB.js";
...
const DatePicker = class {
  ...
  render() {
    return h(Host, { key: "b25899db125efa54769833f3c06fed5eb24d1a1a" }, h("ix-date-time-card", { key: "fab63e45bb48f0245821b0c66ade4df6c9c69473", corners: this.corners, standaloneAppearance: this.standaloneAppearance }, h("div", { key: "478c5bcd70a7145978d8e4fb2e575a5ca0278617", class: "header", slot: "header" }, h("ix-icon-button", { key: "a33e25a6b4e434e5c146027534eeeac5276dab78", onClick: () => this.changeToAdjacentMonth(-1), ghost: true, icon: iconChevronLeftSmall, variant: "primary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "04cb56d9856c4383f953c174720dda2f372368d6", class: "selector" }, h("ix-button", { key: "6167061185b3695e586f5bd154c8fb9e1f4b80e4", ghost: true, ref: this.dropdownButtonRef, "data-testid": "year-month-button" }, h("span", { key: "e3c90dd65e014424d9d31cae102fc739a3413e7e", class: "fontSize capitalize" }, this.monthNames[this.selectedMonth], " ", this.selectedYear)), h("ix-dropdown", { key: "e57d935db52233e9d9d325523ebbc41fd58e5e89", "data-testid": "year-month-dropdown", class: "dropdown", trigger: this.dropdownButtonRef.waitForCurrent(), ignoreRelatedSubmenu: true, placement: "bottom-start" }, h("div", { key: "e6d826f59eed064f93693ebdeb7ca14adce39dbc", class: "wrapper" }, h("div", { key: "be5d42975b8ad11fa4d16179a3954d02a6bfeda5", "data-testid": "year-container", class: "overflow", onScroll: () => this.infiniteScrollYears(), ref: this.yearContainerRef }, this.renderYears()), h("div", { key: "e7055dfc00a0d991072972962fdf34ddb456151c", class: "overflow", "data-testid": "month-container" }, this.monthNames.map((month, index) => h("div", { key: month, ref: (ref) => {
      ...
      checkPosition: true
    }, name: iconSingleCheck, size: "16" }), h("div", null, h("span", { class: "capitalize monthMargin" }, `${month} ${this.tempYear}`)))))))), h("ix-icon-button", { key: "5025df95d0fca7b3efcab225a7e88e173b686b13", onClick: () => this.changeToAdjacentMonth(1), ghost: true, icon: iconChevronRightSmall, variant: "primary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "7cb16f1a4fc33ebb52b16d286bfba4568fa39569", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, this.showWeekNumbers && h("div", { key: "a09017604aa7c5ef2223124879acb8c07878c76e", class: "calendar-item week-day" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day" }, h("div", { class: "overflow" }, name.slice(0, 3)))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "91ce474c793f1731f171eade548c23b3badf0414", class: {
      button: true,
      hidden: !this.range || !this.standaloneAppearance
    } }, h("ix-button", { key: "aca95c074f075257a58f4c316312ef914d20f7a3", onClick: () => this.onDone() }, this.i18nDone))));
  }
  get hostElement() {
