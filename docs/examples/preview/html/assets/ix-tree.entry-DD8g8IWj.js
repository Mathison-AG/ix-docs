...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "1ef871a4ff980e0e231e1fb2544444d49318612c", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "00178bcb7596a1f28f24df7bda0bac88d7455b00" }));
  }
  get hostElement() {
