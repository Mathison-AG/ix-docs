...
import { F as iconDoubleChevronDown, G as iconDoubleChevronRight, H as iconDoubleChevronUp, I as iconDoubleChevronLeft, q as iconClose } from "./index-Cz75KU1f-BUHLjWzB.js";
...
const Pane = class {
  ...
  render() {
    return h(Host, { key: "80b2541d6076c25ab63b58b05f4ea8d33d65da73", class: {
    ...
    } }, h("aside", { key: "cad823d8ecc9b229ac9c7272f8255756843cf3d4", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "8ebe8749fb841ff98e0f6fa0c6c1e62f4864bcaa", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "6c65555b9336ce1220c05c4f2c7c7cac0ac037d6", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, ghost: true, onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}` }), h("span", { key: "b49e8d0b42bffea888ece3930bd8b46b52498f4a", class: {
      "title-text": true,
      rotate: !this.expanded && !this.isMobile && this.isLeftRightPane
    } }, this.icon ? h("ix-icon", { size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }) : null, h("div", { key: "333bcf087e6cd0de1487a35972d90833af775859", class: "title-text-overflow" }, h("ix-typography", { key: "ddb4d3a8b0c7a7391f15f1e05ff46afdfe151084", format: "h4" }, this.heading)))), h("div", { key: "effd401d9b960179a873c6767aabc506e4dea1f2", class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: "9ee32876999e655f2ca5bee2860e123712b9075b" }))));
  }
  get hostElement() {
