...
import { w as iconChevronRightSmall, E as iconChevronLeftSmall } from "./index-Cz75KU1f-BUHLjWzB.js";
...
const TabItem = class {
  ...
  render() {
    return h(Host, { key: "8cadd5bd30ee1bf29d065abd98748529243c86c5", class: this.tabItemClasses({
    ...
    } }, h("div", { key: "06aadb10df17e6a89b25fe5fce1ee5ae30a76bf1", class: {
      circle: this.rounded,
      text: !this.rounded,
      selected: this.selected,
      disabled: this.disabled
    } }, h("slot", { key: "50b47b1838536e0c03ffec8b0460ca3be3b1364e" })), h("div", { key: "5b10f5360bc2c0f3d6cc072a5b07ccdff2237ee0", class: {
      counter: true,
      selected: this.selected,
...
const Tabs = class {
  ...
  render() {
    return h(Host, { key: "41b4e85b7d6e16f0103f777fe460967b035620b6" }, this.showArrowPrevious && h("button", { key: "2f36eeb138dba1ec1b60b2530ce7cecd86928836", class: "arrow", onClick: () => this.move(this.scrollAmount, true), "aria-label": this.ariaLabelChevronLeftIconButton }, h("ix-icon", { key: "b4421460b22344641766385ae39f6f321e6ab0b1", name: iconChevronLeftSmall })), h("div", { key: "b9625d34f9bb02f2a4d481269a8490105c3d80b3", class: {
      "tab-items": true,
    ...
    } }, h("div", { key: "91fcbedb7dd12cf37b1075e210c170a5d60bab39", class: "items-content" }, h("slot", { key: "d333fbb447d54179e159600f019af48df2456ba2" }))), this.showArrowNext && h("button", { key: "8aa30fce0901569a7f699fc017ab154c225db436", class: "arrow right", onClick: () => this.move(-this.scrollAmount, true), "aria-label": this.ariaLabelChevronRightIconButton }, h("ix-icon", { key: "5af552dd0fafb4c4bd4e2cf28b71328c653eb7f4", name: iconChevronRightSmall })));
  }
  get hostElement() {
