...
import { D as iconPlus, l as iconClear, r as iconChevronUpSmall, g as iconChevronDownSmall } from "./index-Cz75KU1f-BUHLjWzB.js";
import { a as a11yBoolean } from "./a11y-Bb7pDeaQ-DNI84lDX.js";
import { A as ArrowFocusController } from "./focus-BAKpVknt-BX94nhwN.js";
import { H as HookValidationLifecycle } from "./validation-C17ol6-l-BiCx1EAO.js";
...
import "./disposable-event-listener-CKoABG1h-D5kNsG5G.js";
...
const Select = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "8283dc2b919bb886bac12eb2814e4437083a77c9", "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    } }, h("ix-field-wrapper", { key: "ba1233f01d025977b3c7667ce34391fc021eca9c", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "159f130da11ea146a8efe1b3be0af4590d2607a5", class: {
      select: true,
      disabled: this.disabled,
    ...
    } }, h("div", { key: "ccf37a27e4192fee18ad9e444a7d17f5623875e2", class: "input-container" }, h("div", { key: "42ed83e12ed0f1ee350e855dcec5255185ed6882", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "a00a4601112c787dd15ec8226e287b5d2a9fed3f", class: "trigger" }, h("input", { key: "11637abccdb658b1cc25e7c6ef44835e12fc19bf", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      if (this.editable)
        this.dropdownWrapperRef(ref);
    }, "aria-label": this.ariaLabelChevronDownIconButton })))))), h("ix-dropdown", { key: "c3109cf515a28c10905145db3a9c3f7f3ca4b488", ref: (ref) => this.dropdownElement = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "891a91fd96cc2c71e6640f8343bdd1eef9548bb1", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "716d77b9190b4389f177bbd139e8265438b03c3f", onSlotchange: () => {
      this.updateSelection();
    } }), h("div", { key: "1bd73f200c2a08ed2af4c40bece06086f6a1c0f4", ref: (ref) => this.customItemsContainerElement = ref }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
      "add-item": true
