...
const ValidationTooltip = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "107e5e27b4e1a8b80d525a56ecc14cd7c6c77abc" }, h("slot", { key: "924d907b9ad205b311ab401278c9282dac72ef6d" }), h("div", { key: "4b215c0ca2d2fe86bf0af96abe912ecc1813429b", role: "tooltip", style: {
      display: "none",
      position: "fixed",
      top: "0",
      left: "0",
    ...
    }, class: "validation-tooltip text-default" }, this.message, h("slot", { key: "9b5cb2080f898022941574936b6b03cc591db843", name: "tooltip-message" }), h("div", { key: "4bcc6facdbd68649a9ec9c2b17da9e31308eef78", id: "arrow" })));
  }
  get hostElement() {
