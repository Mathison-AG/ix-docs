import { r as registerInstance, a as readTask, h, F as Fragment, H as Host, g as getElement, c as createEvent } from "./global-C3NZUKAC.js";
...
const Avatar = class {
  ...
  render() {
    ...
    const Avatar2 = h(Fragment, null, h(AvatarImage, { image: this.image, initials: this.initials, a11yLabel: a11yLabel !== null && a11yLabel !== void 0 ? a11yLabel : this.a11yLabel }), !!tooltipText && h("ix-tooltip", { ref: this.tooltipRef, for: this.hostElement, "aria-hidden": a11yBoolean(ariaHidden), "aria-label": this.ariaLabelTooltip }, tooltipText));
