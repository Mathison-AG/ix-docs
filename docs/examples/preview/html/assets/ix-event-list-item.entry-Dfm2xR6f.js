...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "4158058ddeacbf90e149300ce122275028047a84", class: {
      disabled: this.disabled
    } }, h("div", { key: "3ec23e305e87aab0cf74eb96540da0699086989b", role: "listitem", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "f2ba17f7cc4652a85b798ce9c22570a51b53edb1", class: `indicator ${!this.itemColor ? "indicator-empty" : ""}`, style: {
      "background-color": this.itemColor ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "73cfa604c204a0c57e2681830678d11fec523423", class: "event-list-item-container" }, h("div", { key: "e140f9cfcd198286491ca06d313ded8763b9dbf4", class: "event-content" }, h("slot", { key: "3c9e890578681407a2be1fcf6c8205b24fe2513d" })), this.chevron && h("ix-icon", { key: "44b6df10a7821672a00cabedd398a1e452ab84f6", name: iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))));
  }
};
