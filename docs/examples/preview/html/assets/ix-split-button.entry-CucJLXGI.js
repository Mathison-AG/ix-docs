...
const SplitButton = class {
  ...
  render() {
    ...
    return h(Host, { key: "e57b935fffec1c568a88b2e73df8526844218a88" }, h("div", { key: "edc4729b0bfcd13f2e550667fdde8ad9508d0963", class: { "btn-group": true, "middle-gap": !this.outline } }, this.label ? h("ix-button", Object.assign({}, buttonAttributes, { icon: this.icon, onClick: (e) => this.buttonClick.emit(e) }), this.label) : h("ix-icon-button", Object.assign({}, buttonAttributes, { icon: this.icon, onClick: (e) => this.buttonClick.emit(e), "aria-label": this.ariaLabelButton })), h("ix-icon-button", Object.assign({ key: "ed07e5b13e502ec8ff08314f3802ee81450d2115" }, buttonAttributes, { ref: (r) => this.triggerElement = r, class: "anchor", icon: (_a = this.splitIcon) !== null && _a !== void 0 ? _a : iconContextMenu, "aria-label": this.ariaLabelSplitIconButton }))), h("ix-dropdown", { key: "78ff03129a2d4376bb2fee79a4b3c659fa5638cb", ref: (r) => this.dropdownElement = r, closeBehavior: this.closeBehavior }, h("slot", { key: "9ca785fa9dcf0113cae0d084912806026670d73b" })));
  }
  get hostElement() {
