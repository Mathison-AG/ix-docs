...
import { B as BaseButton } from "./base-button-D7DcR75u-DYj7Yvuh.js";
import { L as LogicalFilterOperator, I as InputState } from "./logical-filter-operator-BH3f5fa3-983MLV_l.js";
import { k as iconSearch, l as iconClear } from "./index-Cz75KU1f-BUHLjWzB.js";
...
const CategoryFilter = class {
  ...
  getResetButton() {
    ...
    }, ghost: true, oval: true, icon: iconClear, iconColor: "color-soft-text", size: "16", "aria-label": this.ariaLabelResetButton });
  }
  getIconColor() {
    if (this.disabled) {
  ...
  render() {
    var _a, _b, _c;
    return h(Host, { key: "acc492cb00230e6d317c597ac04d3122674ab300" }, h("form", { key: "fa568142b6446310a1cfcf53f435a2fb34525d14", ref: (el) => this.formElement = el }, h("div", { key: "df35012d5b081ca47027fd6083df20d096b1919d", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "149202083d2c24ad143a9238aadabceaa38ef3b3", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: (_a = this.icon) !== null && _a !== void 0 ? _a : iconSearch, size: "16" }), h("div", { key: "1cd342d8556ab87f65cd85fe6c165c51c12ff1a3", class: "token-container" }, h("div", { key: "2c13596105873722e801e8e0e8dc2d858d688fec", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 : _b.label), h("input", Object.assign({ key: "e09eebd3408ae24c6b61234b2d9263950e778896", class: {
      "text-input": true,
