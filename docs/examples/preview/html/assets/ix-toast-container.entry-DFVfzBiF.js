import { r as registerInstance, h, H as Host } from "./global-C3NZUKAC.js";
...
const ToastContainer = class {
  ...
  render() {
    return h(Host, { key: "fff71c604ce1ce51770e5a9846c4fa0f362eb81f", class: {
      "toast-container--bottom-right": this.position === "bottom-right",
      "toast-container--top-right": this.position === "top-right"
    } }, h("slot", { key: "8bf8b30c35dae590a9dbb9c20a486883aa969bbb" }));
  }
  static get watchers() {
    return {
