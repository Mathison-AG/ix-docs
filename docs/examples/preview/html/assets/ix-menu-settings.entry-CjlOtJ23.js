import { r as registerInstance, c as createEvent, f as forceUpdate, h, g as getElement, H as Host } from "./global-C3NZUKAC.js";
...
const MenuTabs = ({ context }) => {
  ...
  return h(
    ...
    h(
      ...
      h("ix-icon-button", { ghost: true, size: "24", icon: iconClose, iconColor: "color-soft-text", onClick: (e) => context.close.emit({
