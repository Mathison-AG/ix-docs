...
import { U as UploadFileState } from "./upload-file-state-BGzrnl_l-DLdhtkd7.js";
import { c as iconSuccess, b as iconError } from "./index-Cz75KU1f-BUHLjWzB.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "54c0f268e501179e82f1e2e0730d168fcdc9bf3c" }, a11y, { "aria-disabled": disabled }), h("div", { key: "c3d0e5d843fb8c9d934f5271121bcabf9392ea0c", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), h("div", { key: "4b8a678504d89e45dce9c745ffba0474fa655125" }, h("input", { key: "628d42dded1007126f61ae4f46beb0c424911d72", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "becc7667fa38d433a8bd43bd022d5f126595baa0", "aria-disabled": disabled, outline: true, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
  get hostElement() {
