...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "e7ea08567f6778ba160b8f49dde381c4ef7f2d28", class: {
      visible: this.modalVisible,
      "no-backdrop": this.backdrop === false,
      "align-center": this.centered
    } }, h("div", { key: "b350c757be80fab1bc1c3c8ebd326c6030d29204", class: "dialog-backdrop" }, h("dialog", { key: "eaec281364e60b8e74e0bd7b0df2a496299a0840", "aria-modal": a11yBoolean(true), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      [`modal-size-${this.size}`]: true
    }, onClose: () => this.dismissModal(), onMouseDown: (event) => this.onMouseDown(event), onMouseUp: (event) => this.onMouseUp(event), onCancel: (e) => {
      e.preventDefault();
      this.dismissModal();
    } }, h("slot", { key: "62f6f8891c01a33fc1deed56df8e1cb05deaad52" }))));
  }
  get hostElement() {
