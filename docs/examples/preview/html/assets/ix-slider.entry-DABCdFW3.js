...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "94cff1b00c3fc47041ee7c68dadbb859834c0fa5", class: {
      disabled: this.disabled,
      error: !!this.error
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("div", { key: "7ab2f7581859e87205ab8d5f7182f66a1cf22c50", class: "slider" }, h("div", { key: "8994409fbbc286657bf41e1a904286608f485ec5", class: "track" }, h("div", { key: "19e00720cf601846bcb626a918e856c1b460cfdb", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * 100% - 8px)`
    } }), h("div", { key: "15634922958e34865b237f3de92cb250429ddf0d", class: "ticks" }, this.marker ? this.marker.map((markerValue) => {
    ...
    }) : null)), h("input", Object.assign({ key: "2b0d440bff908c9d137bbb41fa6ef95e9258e833", id: "slider", type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), style: {
      ...
      this.showTooltip = false;
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max }, this.a11yAttributes)), h("ix-tooltip", { key: "b12f93676a54d1bf232f02034e047798b5511563", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), h("div", { key: "e486a8162531b17c9c0510966c281b1e0d422679", class: "label" }, h("div", { key: "69402b351a033562e7f92d2693a774e898631f5d", class: "label-start" }, h("slot", { key: "4783e40945f731c4250d281158db22b9a625cdde", name: "label-start" })), h("div", { key: "99d40a09673bd8e293760490934fbe5c9fd07e72", class: "label-end" }, h("slot", { key: "dcde71f89c5faf1f46b4874d19bdfa5f44e513a8", name: "label-end" }))), this.error ? h("ix-typography", { class: "label-error", textColor: "alarm" }, this.error) : null);
  }
  get hostElement() {
