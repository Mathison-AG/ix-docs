...
const RadiobuttonGroup = class {
  ...
  render() {
    return h(Host, { key: "037bd95bf0cf37b3644cab97ea5bb12bee650c4f", onIxBlur: () => this.touched = true, ref: this.groupRef }, h("ix-field-wrapper", { key: "d9618f6fb77dcd253c9c7f7dfc39c48730755ace", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.groupRef }, h("div", { key: "413132b9c1c0c0a22db55aa1a4645856e14ed89b", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "5f7d22f7582b1186735dbc1cc20f83a99fe6afca" }))));
  }
  get hostElement() {
