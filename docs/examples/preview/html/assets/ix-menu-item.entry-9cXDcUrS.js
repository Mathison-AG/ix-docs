...
import { T as iconDocument } from "./index-Cz75KU1f-BUHLjWzB.js";
...
const MenuItem = class {
  ...
  setTooltip() {
    var _a, _b, _c;
    this.tooltip = (_c = (_b = (_a = this.tooltipText) !== null && _a !== void 0 ? _a : this.label) !== null && _b !== void 0 ? _b : this.hostElement.textContent) !== null && _c !== void 0 ? _c : void 0;
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "a00061cba6e30b2c173677180c97bab86a8a5229", class: {
      disabled: this.disabled,
      "home-tab": this.home,
      "bottom-tab": this.bottom,
      active: this.active,
      "tab-nested": this.isHostedInsideCategory
    } }, extendedAttributes), h("button", { key: "cf91197542b24c3d4de03f463b42a465d2874d8f", class: "tab", tabIndex: this.disabled ? -1 : 0, ref: this.buttonRef }, this.icon && h("ix-icon", { key: "7872787f5be35f48e0608f3efec7dc70f6de3521", class: "tab-icon", name: this.icon }), this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null, h("span", { key: "c1791eba44908e6e768d549ab1d9294ffcab5f93", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "f6c1621820955a28184404b02ef8a5fb0f07ff7d" }))), h("ix-tooltip", { key: "e7937db2f0e84dc94d30ac64dc717572b91ff8ef", for: this.buttonRef.waitForCurrent(), placement: "right", showDelay: 1e3, interactive: false, "aria-hidden": a11yBoolean(this.ariaHiddenTooltip), "aria-labelledby": this.internalItemId }, this.tooltip));
  }
  get hostElement() {
